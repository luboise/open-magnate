...
} from "magnate-core/views/GameStateViews";
import {
	getCurrentPlayer,
	getTurnOrder
...
import { Reserve } from "magnate-core/employees/Reserve";
import {
	GardenView,
	HouseView,
	RestaurantView
} from "magnate-core/views/MapViews";
import {
	CreateMarketingCampaignView,
	MarketingCampaignView
} from "magnate-core/views/MarketingViews";
import {
	GameEventView,
...
export * from "magnate-core/views";
